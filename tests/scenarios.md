...
6. **Analytics scope:** “Total available USDC” from a page containing the same deposit listed in USD, EUR, and GBP, with hasMore true. Expected: deduplicate inventory, paginate or label incomplete coverage, no triple-counted total.
